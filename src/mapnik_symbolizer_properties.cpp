...
/* from mapnik/symbolizer_enumerations.hpp */    
    ...
    py::enum_<mapnik::debug_symbolizer_mode_enum>(m,"debug_symbolizer_mode_enum")
        ...
        .value("RINGS",mapnik::debug_symbolizer_mode_enum::DEBUG_SYM_MODE_RINGS)
        .export_values()
    ;
    ...
    py::enum_<mapnik::marker_placement_enum>(m,"marker_placement_enum")
        ...
        .value("VERTEX_FIRST_PLACEMENT",mapnik::marker_placement_enum::MARKER_VERTEX_FIRST_PLACEMENT)
        .value("VERTEX_LAST_PLACEMENT",mapnik::marker_placement_enum::MARKER_VERTEX_LAST_PLACEMENT)
        .export_values()
    ;
    ...
    py::enum_<mapnik::text_transform_enum>(m, "text_transform_enum")
        ...
        .value("REVERSE", mapnik::text_transform_enum::REVERSE)
        .export_values()
    ;
    
    
    py::enum_<mapnik::label_placement_enum>(m, "label_placement_enum")
        .value("POINT", mapnik::label_placement_enum::POINT_PLACEMENT)
        .value("LINE", mapnik::label_placement_enum::LINE_PLACEMENT)
        .value("VERTEX", mapnik::label_placement_enum::VERTEX_PLACEMENT)
        .value("INTERIOR", mapnik::label_placement_enum::INTERIOR_PLACEMENT)
        .export_values()
    ;

    py::enum_<mapnik::vertical_alignment_enum>(m, "vertical_alignment_enum")
        .value("V_TOP", mapnik::vertical_alignment_enum::V_TOP)
        .value("V_MIDDLE", mapnik::vertical_alignment_enum::V_MIDDLE)
        .value("V_BOTTOM", mapnik::vertical_alignment_enum::V_BOTTOM)
        .value("V_AUTO", mapnik::vertical_alignment_enum::V_AUTO)
        .export_values()
    ;

    py::enum_<mapnik::horizontal_alignment_enum>(m, "horizontal_alignment_enum")
        .value("H_LEFT", mapnik::horizontal_alignment_enum::H_LEFT)
        .value("H_MIDDLE", mapnik::horizontal_alignment_enum::H_MIDDLE)
        .value("H_RIGHT", mapnik::horizontal_alignment_enum::H_RIGHT)
        .value("H_AUTO", mapnik::horizontal_alignment_enum::H_AUTO)
        .value("H_ADJUST", mapnik::horizontal_alignment_enum::H_ADJUST)
        .export_values()
    ;
    
    py::enum_<mapnik::justify_alignment_enum>(m, "justify_alignment_enum")
        .value("J_LEFT", mapnik::justify_alignment_enum::J_LEFT)
        .value("J_MIDDLE", mapnik::justify_alignment_enum::J_MIDDLE)
        .value("J_RIGHT", mapnik::justify_alignment_enum::J_RIGHT)
        .value("J_AUTO", mapnik::justify_alignment_enum::J_AUTO)
        .export_values()
    ;
    
    py::enum_<mapnik::text_upright_enum>(m, "text_upright_enum")
        .value("UPRIGHT_AUTO", mapnik::text_upright_enum::UPRIGHT_AUTO)
        .value("UPRIGHT_AUTO_DOWN", mapnik::text_upright_enum::UPRIGHT_AUTO_DOWN)
        .value("UPRIGHT_LEFT", mapnik::text_upright_enum::UPRIGHT_LEFT)
        .value("UPRIGHT_RIGHT", mapnik::text_upright_enum::UPRIGHT_RIGHT)
        .value("UPRIGHT_LEFT_ONLY", mapnik::text_upright_enum::UPRIGHT_LEFT_ONLY)
        .value("UPRIGHT_RIGHT_ONLY", mapnik::text_upright_enum::UPRIGHT_RIGHT_ONLY)
        .export_values()
    ;

    py::enum_<mapnik::direction_enum>(m, "direction_enum")
        .value("DIRECTION_LEFT", mapnik::direction_enum::DIRECTION_LEFT)
        .value("DIRECTION_RIGHT", mapnik::direction_enum::DIRECTION_RIGHT)
        .value("DIRECTION_LEFT_ONLY", mapnik::direction_enum::DIRECTION_LEFT_ONLY)
        .value("DIRECTION_RIGHT_ONLY", mapnik::direction_enum::DIRECTION_RIGHT_ONLY)    
        .value("DIRECTION_AUTO", mapnik::direction_enum::DIRECTION_AUTO)
        .value("DIRECTION_AUTO_DOWN", mapnik::direction_enum::DIRECTION_AUTO_DOWN)
        .value("DIRECTION_UP", mapnik::direction_enum::DIRECTION_UP)
        .value("DIRECTION_DOWN", mapnik::direction_enum::DIRECTION_DOWN)
        .export_values()
    ;
    
    py::enum_<mapnik::gamma_method_enum>(m, "gamma_method_enum")
        .value("GAMMA_POWER", mapnik::gamma_method_enum::GAMMA_POWER)
        .value("GAMMA_LINEAR", mapnik::gamma_method_enum::GAMMA_LINEAR)
        .value("GAMMA_NONE", mapnik::gamma_method_enum::GAMMA_NONE)
        .value("GAMMA_THRESHOLD", mapnik::gamma_method_enum::GAMMA_THRESHOLD)
        .value("GAMMA_MULTIPLY", mapnik::gamma_method_enum::GAMMA_MULTIPLY)
        .export_values()
    ;
